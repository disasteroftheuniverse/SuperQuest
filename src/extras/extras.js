...
module.exports = {
   ...
   check_devices: check_devices = AFRAME.registerComponent('check-devices', {
      dependencies: ['position'],
      schema: {},
      init: function () {
   ...
   clickable: clickable = AFRAME.registerComponent('clickable', {
      schema: {
         type: 'boolean',
         default: true
      },
   ...
   signal_remove: AFRAME.registerComponent('event-remove', {
      ...
      init: function () {
         this.onQualifiedEvent = function (evt) {
   ...
   signal: AFRAME.registerComponent('signal', {
      ...
      multiple: true,
      __handleRegisteredEvents: function (e) {
         var detail = {};
